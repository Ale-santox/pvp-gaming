def on_player2_button_b_pressed():
    animation.run_image_animation(mySprite2,
        ...
        100,
        False)
    mySprite2.start_effect(effects.blizzard, 500)
    if mySprite2.overlaps_with(mySprite) and not (controller.player1.is_pressed(ControllerButton.A)):
        info.player1.set_life(info.player1.life() - 10)
...
def on_player2_button_a_pressed():
    animation.run_image_animation(mySprite2,
        ...
        100,
        False)
    mySprite2.start_effect(effects.cool_radial, 500)
...
def on_player1_button_a_pressed():
    animation.run_image_animation(mySprite,
        ...
        100,
        False)
    mySprite.start_effect(effects.warm_radial, 500)
...
def on_player1_button_b_pressed():
    ...
    if mySprite.overlaps_with(mySprite2) and not (controller.player2.is_pressed(ControllerButton.A)):
        info.player2.set_life(info.player2.life() - 10)
...
mySprite2 = sprites.create(img("""
    ...
    """),
    SpriteKind.player)
mySprite.set_position(40, 75)
mySprite2.set_position(130, 75)
mySprite.set_stay_in_screen(True)
mySprite2.set_stay_in_screen(True)
info.player2.set_life(100)
info.player1.set_life(100)
controller.player1.move_sprite(mySprite, 50, 0)
